     ...
     // Debug guard
      ...
      // ✅ FIX: randomUUID fallback for older browsers
      function uuid() {
...
document.getElementById("autofail-message").style.display = state.autoFailed
  ...
  el.style.color = "#22c55e";
      ...
      // ✅ FIX: Single, valid delegated click handler (all actions inside)
